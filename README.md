...
| [Mova](packages/mova.json) | Discover templates, todos and agenda rows; create and manage todos through Mova's Android intents | All 15 capabilities were verified with EVA Debug and Mova 7.0.1 on a Pixel 11 Pro Fold. The 0.5.0 unattended-write request follows Mova 7.1.1's source contract and has JVM coverage; device verification is pending. |
